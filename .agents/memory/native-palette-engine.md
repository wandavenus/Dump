...
## Dart Cache
LRU 256 entries + debounced disk persist to `artwork/palette_cache_v4.json`.
Cache was bumped to v4 when the native candidate search widened to top-24 and
the bitmap decode changed to ARGB_8888.
