    ...
    return ThemeData(
      ...
      extensions: [
        AppThemeExtension(
          ...
          codeBackground: isDark ? const Color(0xFF0A0A0A) : const Color(0xFFE5E5EA),

          // ── Semantic labels ────────────────────────────────────────────────
          primaryLabel:    isDark ? Colors.white              : const Color(0xFF111111),
          secondaryLabel:  isDark ? const Color(0xFF8E8E93)   : const Color(0xFF6C6C70),
          tertiaryLabel:   isDark ? const Color(0xFF636366)   : const Color(0xFF8E8E93),
          quaternaryLabel: isDark ? const Color(0xFF48484A)   : const Color(0xFFAEAEB2),
          ...
          subtleSeparator:   isDark ? const Color(0xFF38383A) : const Color(0xFFD1D1D6),
          hairlineSeparator: isDark ? const Color(0xFF111111) : const Color(0xFFE5E5EA),
          ...
          eqCenterTick:   isDark ? const Color(0xFF636366) : const Color(0xFF8E8E93),
          eqDisabledColor: isDark ? const Color(0xFF3A3A3C) : const Color(0xFFD1D1D6),
        ),
      ],
    );
  }
