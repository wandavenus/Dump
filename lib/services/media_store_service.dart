...
class MediaStoreService {
  ...
  static Future<List<LocalSong>> _refreshSongsImpl() async {
    ...
    try {
      ...
      LogService.error(
        'MediaStore',
        'getSongs timed out waiting for native response',
      );
  ...
  static final List<LocalSong> _webSampleSongs = List.unmodifiable([
    const LocalSong(
      ...
      title: 'Senja di Ufuk',
      artist: 'Nadia Kirana',
      path: 'web-sample://1001',
      album: 'Cerita Kota',
      albumId: 5001,
      duration: Duration(minutes: 3, seconds: 42),
      year: 2022,
      trackNumber: 1,
      albumArtist: 'Nadia Kirana',
      genre: 'Pop',
    ),
    const LocalSong(
      id: 1002,
    ...
    const LocalSong(
      id: 1003,
      title: 'Hujan November',
      artist: 'Nadia Kirana',
      path: 'web-sample://1003',
      album: 'Cerita Kota',
      albumId: 5001,
    ...
    const LocalSong(
      ...
      title: 'Jalan Pulang',
      artist: 'Bara Santoso',
      path: 'web-sample://1004',
      album: 'Perjalanan',
      albumId: 5002,
      duration: Duration(minutes: 5, seconds: 10),
      year: 2020,
      trackNumber: 1,
      albumArtist: 'Bara Santoso',
      genre: 'Rock',
    ),
    const LocalSong(
      id: 1005,
    ...
    const LocalSong(
      id: 1006,
      title: 'Rindu Sepanjang Jalan',
      artist: 'Bara Santoso',
      path: 'web-sample://1006',
      album: 'Perjalanan',
      albumId: 5002,
    ...
    const LocalSong(
      id: 1007,
      title: 'Bintang Kecil Baru',
      artist: 'Diaz Ramadhan',
      path: 'web-sample://1007',
      album: 'Malam Kota',
      albumId: 5003,
      duration: Duration(minutes: 3, seconds: 15),
      year: 2023,
      trackNumber: 1,
      albumArtist: 'Diaz Ramadhan',
      genre: 'Jazz',
    ),
    const LocalSong(
      id: 1008,
    ...
    const LocalSong(
      ...
      title: 'Ombak Tenang',
      artist: 'Sinta Melati',
      path: 'web-sample://1011',
      album: 'Kilau',
      albumId: 5004,
      duration: Duration(minutes: 4, seconds: 12),
      year: 2024,
      trackNumber: 2,
      albumArtist: 'Sinta Melati',
      genre: 'Pop',
    ),
    const LocalSong(
      id: 1012,
      title: 'Cahaya Pertama',
      artist: 'Sinta Melati',
      path: 'web-sample://1012',
      album: 'Titik Awal',
      albumId: 5005,
  ...
  static void cancelMetadataPrescanner() {
    unawaited(
      _channel
          .invokeMethod<void>('cancelMetadataPrescanner')
          .catchError((_) {}),
    );
  }
  ...
  static Future<bool> deleteSong(int songId) async {
    try {
      ...
      LogService.error(
        'MediaStore',
        'deleteSong platform error: $error',
        stackTrace: stackTrace.toString(),
      );
      return false;
    } on Object catch (error, stackTrace) {
      LogService.error(
        'MediaStore',
        'deleteSong unexpected error: $error',
        stackTrace: stackTrace.toString(),
      );
      return false;
    }
  ...
  static Future<String?> getArtworkPath(int songId) async {
    ...
    try {
      ...
      LogService.error(
        'MediaStore',
        'getArtworkPath unexpected error songId=$songId: $e',
      );
      return null;
    }
  }
