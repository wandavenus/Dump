...
class LyricsSettings {
  ...
  static final ValueNotifier<double> fontSize = ValueNotifier(34.0);

  /// Jarak vertikal di atas dan di bawah setiap baris lirik dalam logical px.
  static final ValueNotifier<double> lineSpacing = ValueNotifier(18.0);
  ...
  static Future<void> init() async {
    ...
    fontSize.value = p.getDouble('lyr_fontSize') ?? 34.0;
    lineSpacing.value = p.getDouble('lyr_lineSpacing') ?? 18.0;
