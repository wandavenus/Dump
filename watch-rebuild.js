...
const BUILD_CMD = `"${FLUTTER_BIN}" build web --release --base-href / --no-tree-shake-icons --no-wasm-dry-run`;
...
function runBuild() {
  ...
  exec(BUILD_CMD, { env: { ...process.env, PATH: `/home/runner/workspace/flutter-ws/flutter/bin:${process.env.PATH}` } }, (err, stdout, stderr) => {
    building = false;
